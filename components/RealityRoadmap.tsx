...
export default function RealityRoadmap({ dream }: { dream: string }) {
  ...
  if (loading) {
    return (
      <div className="space-y-24 w-full animate-pulse px-4">
        ...
        <div className="max-w-6xl mx-auto space-y-12">
           {/* Skeleton Score Card */}
           <div className="h-40 w-full bg-white/5 rounded-3xl border border-white/10" />
           {/* Skeleton Grid */}
           <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="h-64 w-full bg-white/5 rounded-3xl border border-white/10" />
             <div className="h-64 w-full bg-white/5 rounded-3xl border border-white/10" />
           </div>
           {/* Skeleton Roadmap columns */}
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
             <div className="h-80 w-full bg-white/5 rounded-2xl border-l-4 border-l-blue-500/30" />
             <div className="h-80 w-full bg-white/5 rounded-2xl border-l-4 border-l-purple-500/30" />
             <div className="h-80 w-full bg-white/5 rounded-2xl border-l-4 border-l-pink-500/30" />
           </div>
        </div>
      </div>
    );
    ...
    <div className="space-y-24">
      ...
      <div className="flex justify-center pb-20 mt-10">
        <button
          ...
          className="px-12 py-5 bg-gradient-to-r from-[#7c6af7] to-[#d4537e] text-white font-black uppercase tracking-widest text-sm rounded-full shadow-[0_0_30px_rgba(124,106,247,0.3)] hover:shadow-[0_0_40px_rgba(124,106,247,0.5)] hover:scale-105 active:scale-95 transition-all flex items-center gap-3 relative z-10"
        >
          <Award size={22} className="text-white" />
          Research Another Future
        </button>
      </div>
    </div>
  );
