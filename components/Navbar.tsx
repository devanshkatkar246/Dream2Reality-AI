...
const TEAM = [
  { initial: "J", name: "Jeet Dubey", role: "Product Strategist & Ideation Lead", color: "#a594ff", bg: "rgba(124,106,247,0.2)" },
  { initial: "S", name: "Saanvi Gupta", role: "Presenter & Communications Lead", color: "#2dd4bf", bg: "rgba(45,212,191,0.2)" },
  { initial: "D", name: "Devansh Katkar", role: "Full Stack Developer & AI Architect- Lead Engineer", color: "#f59e0b", bg: "rgba(245,158,11,0.2)" },
  { initial: "K", name: "Kajal Kumawat", role: "Design Review & Documentation Lead", color: "#d4537e", bg: "rgba(212,83,126,0.2)" },
]
    ...
    <>
      <nav 
        style={{
          ...
          background: "rgba(7, 8, 15, 0.8)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)",
