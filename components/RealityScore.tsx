  ...
  return (
    <div className="glass-card p-10 rounded-3xl relative overflow-hidden flex flex-col items-center text-center">
      ...
      <motion.button 
        ...
        whileTap={{ scale: 0.97 }}
        className="mt-12 px-8 py-3.5 bg-gradient-to-br from-[#7c6af7] to-[#d4537e] text-white rounded-xl transition-all text-sm font-bold shadow-[0_0_30px_rgba(124,106,247,0.3)] border-none"
      >
        Share My Real Score
      </motion.button>
