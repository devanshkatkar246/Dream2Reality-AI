...
Return ONLY valid JSON in this format:
{
  "career_paths": [
    { 
      ...
      "qualifications": "A short summary of required education/certs",
      "timeToReady": "X-Y months"
    }
  ],
  "skills": [
    { "name": "Skill Name", "level": "Beginner/Intermediate/Advanced", "importance": 1-10, "score": 0-100 }
  ],
